    ...
    public Cuboid contract(CuboidDirection dir) {
        ...
        switch (dir) {
            case Down:
                ...
                return new Cuboid(this.worldName, this.x1, this.y1,
                        this.z1, this.x2, face.y2, this.z2);
            case Up:
                while (face.containsOnly(0)
                        && face.y2 < this.y2) {
                ...
                return new Cuboid(this.worldName, this.x1,
                        face.y1, this.z1, this.x2, this.y2,
                        this.z2);
            case North:
                while (face.containsOnly(0)
                        && face.x1 > this.x1) {
                ...
                return new Cuboid(this.worldName, this.x1, this.y1,
                        this.z1, face.x2, this.y2, this.z2);
            case South:
                while (face.containsOnly(0)
                        && face.x2 < this.x2) {
                    face = face.shift(CuboidDirection.South, 1);
                }
                return new Cuboid(this.worldName, face.x1,
                        this.y1, this.z1, this.x2, this.y2, this.z2);
            case East:
                while (face.containsOnly(0)
                        && face.z1 > this.z1) {
                ...
                return new Cuboid(this.worldName, this.x1, this.y1,
                        this.z1, this.x2, this.y2, face.z2);
            case West:
                while (face.containsOnly(0)
                        && face.z2 < this.z2) {
                ...
                return new Cuboid(this.worldName, this.x1, this.y1,
                        face.z1, this.x2, this.y2, this.z2);
            default:
                throw new IllegalArgumentException("Invalid direction "
                        + dir);
        }
